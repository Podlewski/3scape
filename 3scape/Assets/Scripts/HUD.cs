...
public class HUD : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!GlobalVariable.direction) //w prawo
        {
            ...
            {
                knightRT.transform.localPosition = new Vector3(-950.0f, knightRT.localPosition.y, knightRT.localPosition.z);
                mageRT.transform.localPosition = new Vector3(350.0f, mageRT.localPosition.y, mageRT.localPosition.z);
                archerRT.transform.localPosition = new Vector3(1650.0f, archerRT.localPosition.y, archerRT.localPosition.z);
            }
            else if (posArcher == 3 && posKnight == 2 && posMage == 1)
            {
                archerRT.transform.localPosition = new Vector3(-950.0f, archerRT.localPosition.y, archerRT.localPosition.z);
                knightRT.transform.localPosition = new Vector3(350.0f, knightRT.localPosition.y, knightRT.localPosition.z);
                mageRT.transform.localPosition = new Vector3(1650.0f, mageRT.localPosition.y, mageRT.localPosition.z);
            }
            else if (posMage == 3 && posArcher == 2 && posKnight == 1)
            {
                mageRT.transform.localPosition = new Vector3(-950.0f, mageRT.localPosition.y, mageRT.localPosition.z);
                archerRT.transform.localPosition = new Vector3(350.0f, archerRT.localPosition.y, archerRT.localPosition.z);
                knightRT.transform.localPosition = new Vector3(1650.0f, knightRT.localPosition.y, knightRT.localPosition.z);
            }
