...
* [x] Usprawnienia dla planszy końcowej po poziomie. 
* [x] Licznik dla możliwych do postawienia / postawionych bomb
* [ ] Licznik umiejscowiony w dobrym miejscu
* [x] Postawione bomby po 20 sekundach same z siebie wybuchają. 
* [x] Naprawiony błąd z nieznikającymi strzałami/pociskami oraz wyskakującymi nullami.
