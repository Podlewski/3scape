...
* Zmieniamy kolejność bohaterów za pomocą klawiszy *O* (zamiana postaci z prawej strony oraz środka) oraz *P* (zamiana postaci ze środka i lewej strony),
* Aby wykonać atak na wojowniku należy użyć przycisku *K* (tylko będąc z lewej strony),
* Aby łotrzyk strzelił należy wcisnąć *K* (tylko będąc z lewej strony),
